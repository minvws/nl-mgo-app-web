...
testSet(
    'nlCoreHumanname parses successfully',
...
test.each([
    ...
    undefined,
])('nlCoreHumanname parses successfully when there data is undefined', (data) => {
...
testSet(
    'nlCoreHumanname UI schema group is created successfully',
    () => {
