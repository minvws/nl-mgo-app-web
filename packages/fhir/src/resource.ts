...
export type FhirR3R4<T extends FhirVersion, R3, R4> = T extends 'R3'
    ? R3
    : T extends 'R4'
      ? R4
      : R3 | R4;

export type ResourceType<V extends FhirVersion = FhirVersion> = FhirResource<V>['resourceType'];

export type ResourceByType<
    T extends ResourceType<V>,
    V extends FhirVersion = FhirVersion,
> = Extract<FhirResource<V>, { resourceType: T }>;

export type FhirResource<V extends FhirVersion = FhirVersion> = FhirR3R4<
    V,
    FhirResourceR3,
    FhirResourceR4
>;
