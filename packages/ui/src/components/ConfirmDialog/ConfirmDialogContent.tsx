...
export const ConfirmDialogContent = ({
    ...
    loadingSpinnerOnly,
    ...rest
}: ConfirmDialogContentProps & AllOrNone<ButtonLoadingProps>) => {
    ...
    return (
        <AlertDialog.Portal>
            ...
            <AlertDialog.Content
                className="fixed top-0 left-0 z-50 h-full w-full overflow-x-hidden overflow-y-auto p-4 md:p-6"
                {...rest}
            >
                    ...
                    <div className="bg-t-bg-secondary flex w-full max-w-[432px] flex-col rounded-lg p-4 sm:p-6">
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:gap-6">
                            ...
                            <AlertDialog.Action asChild>
                                <Button className="grow" onClick={handleConfirm} {...loadingProps}>
                                    {confirmButtonText}
                                </Button>
                            </AlertDialog.Action>
                        </div>
