...
test('returns the expected output 01', () => {
    const output = gpLaboratoryResult.parse(input01 as Observation, faker.custom.i18nContext());
...
test('returns the expected output 02', () => {
    const output = gpLaboratoryResult.parse(input02 as Observation, faker.custom.i18nContext());
...
test('returns the expected output 03', () => {
    const output = gpLaboratoryResult.parse(input03 as Observation, faker.custom.i18nContext());
