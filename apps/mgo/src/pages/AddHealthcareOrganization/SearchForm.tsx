    ...
    const validate = useCallback(() => {
        ...
        if (name.length === 0) {
            errorMessages.name = _(
                msg({
                    id: 'add-healthcare-organization.input.name.validation',
        ...
        if (city.length === 0) {
            errorMessages.city = _(
                msg({
                    id: 'add-healthcare-organization.input.city.validation',
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 md:flex-row" noValidate>
            <InputField
                ...
                label={
                    <>
                        <Trans id="add-healthcare-organization.input.name.label">Naam</Trans>
            ...
            <InputField
                ...
                label={
                    <>
                        <Trans id="add-healthcare-organization.input.city.label">Plaats</Trans>
                        <span className="ml-1" aria-hidden="true">
                            <Trans id="common.required">(verplicht)</Trans>
                        </span>
                    </>
