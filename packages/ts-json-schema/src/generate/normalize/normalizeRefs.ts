...
import { JSONSchema7, JSONSchema7Definition, SchemaWithDefinitions } from '../../schemaTypes.js';
...
function replaceRefsInObject(node: JSONSchema7, toRename: Record<string, string>): void {
    ...
    for (const key of Object.keys(node)) {
        replaceRefsInNode((node as Record<string, JSONSchema7Definition>)[key], toRename);
    }
}
