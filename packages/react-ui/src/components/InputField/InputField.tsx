...
export const InputField = ({
    ...
    return (
        <div className={twMerge(`flex w-full flex-col gap-3`, className)} {...rest}>
            ...
            <input
                className="text-md h-16 rounded-lg border border-gray-500 p-4 shadow-sm outline-none focus:border-black dark:bg-gray-900 dark:text-white dark:focus:border-white"
                type={type}
                id={inputId}
                name={name}
                required={required}
            ...
            {error && (
                <span
                    className="text-md flex items-center gap-2 font-bold leading-normal text-[#D52A1E]"
