 ...
 */
function parseZibAllergyIntolerance(resource: AllergyIntolerance, _i18nContext: I18nContext) {
    return {
...
export const zibAllergyIntolerance = {
    ...
    uiSchema,
} satisfies ResourceConfigR3<AllergyIntolerance, ZibAllergyIntolerance>;
