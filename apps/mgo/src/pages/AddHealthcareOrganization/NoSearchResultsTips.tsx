...
export const NoSearchResultsTips = () => (
    <List>
        <ListItem className="text-md flex">
            ...
            <span>
                <Trans id="add-healthcare-organization.no-results.usp.1">
        ...
        <ListItem className="text-md flex">
            <ListIcon icon="arrow-right-alt" className="fill-dark-blue-700 me-2 h-5 w-5" />
            <span>
                <Trans id="add-healthcare-organization.no-results.usp.2">
        ...
        <ListItem className="text-md flex">
            <ListIcon icon="arrow-right-alt" className="fill-dark-blue-700 me-2 h-5 w-5" />
            <span>
                <Trans id="add-healthcare-organization.no-results.usp.3">
